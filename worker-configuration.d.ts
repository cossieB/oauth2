/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: f340aed0f37da1d1b73bfb6d96704b87)
// Runtime types generated with workerd@1.20260518.1 2026-05-25 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	KV: KVNamespace;
	R2: R2Bucket;
	DB: D1Database;
	ISSUER: "https://oauth.cossie.workers.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ISSUER" | "COOKIE_SECRET" | "NODE_ENV" | "STORAGE_DOMAIN">> {}
}
